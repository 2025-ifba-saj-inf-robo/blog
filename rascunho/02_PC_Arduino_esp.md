Os sources fornecem informações sobre PCs e microcontroladores como o Arduino, além de mencionarem a arquitetura ARM, que é frequentemente usada em dispositivos como o ESP. Podemos apresentar algumas comparações com base nas informações disponíveis, embora os sources não forneçam imagens diretas para ilustrá-las.
